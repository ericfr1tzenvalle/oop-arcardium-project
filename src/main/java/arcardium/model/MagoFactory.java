...
// ===================== ARQUÉTIPOS ORIGINAIS (ajustados) =====================
    public Mago criarMagoDeBatalha(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                15, TipoDeEfeito.BUFF_ATAQUE, 10, 2, TipoAlvo.ALIADO,
                NomeEfeito.FORCA_DO_URSO, List.of(TagMagia.NATUREZA, TagMagia.BUFF)));

        mago.aprenderMagia(new Magia(
                "Impacto Sísmico", "Batendo o cajado no chão e abalando o campo",
                22, TipoDeEfeito.DANO_DIRETO, 15, 1, TipoAlvo.TODOS_INIMIGOS,
                NomeEfeito.NENHUM, List.of(TagMagia.NATUREZA, TagMagia.DANO, TagMagia.AREA)));
    ...
    public Mago criarMagoArcano(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                15, TipoDeEfeito.DANO_DIRETO, 26, 1, TipoAlvo.ALVO_UNICO,
                NomeEfeito.NENHUM, List.of(TagMagia.ARCANA, TagMagia.DANO, TagMagia.ALVO_UNICO)));

        mago.aprenderMagia(new Magia(
                "Escudo Arcano", "Protegendo o aliado com escudo mágico",
                15, TipoDeEfeito.BUFF_DEFESA, 18, 2, TipoAlvo.ALIADO,
                NomeEfeito.RESISTENTE, List.of(TagMagia.ARCANA, TagMagia.BUFF, TagMagia.ALVO_UNICO)));
        return mago;
    }
    ...
    public Mago criarEscolhido(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                12, TipoDeEfeito.DANO_DIRETO, 24, 1, TipoAlvo.ALVO_UNICO,
                NomeEfeito.NENHUM, List.of(TagMagia.SORTE, TagMagia.DANO, TagMagia.ALVO_UNICO)));

        mago.aprenderMagia(new Magia(
                "Sorte Sorte Sorte!", "Aumentando temporariamente a chance de esquiva",
                15, TipoDeEfeito.BUFF_EVASAO, 18, 3, TipoAlvo.ALVO_UNICO,
                NomeEfeito.AGIL, List.of(TagMagia.SORTE, TagMagia.BUFF, TagMagia.ALVO_UNICO)));

        // crítico ligeiramente acima da média por tema "sorte"
    ...
    public Mago criarPadre(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                15, TipoDeEfeito.DANO_DIRETO, 30, 1, TipoAlvo.ALVO_UNICO,
                NomeEfeito.NENHUM, List.of(TagMagia.LUZ, TagMagia.DANO, TagMagia.ALVO_UNICO)));

        mago.aprenderMagia(new Magia(
                "Benção do Pai", "Curando lentamente um aliado",
                20, TipoDeEfeito.CURA, 30, 3, TipoAlvo.ALIADO,
                NomeEfeito.CURA_REGENERATIVA, List.of(TagMagia.LUZ, TagMagia.CURA, TagMagia.ALVO_UNICO)));
        return mago;
    }
    ...
    public Mago criarPiromante(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                18, TipoDeEfeito.DANO_DIRETO, 32, 1, TipoAlvo.ALVO_UNICO,
                NomeEfeito.NENHUM, List.of(TagMagia.FOGO, TagMagia.DANO, TagMagia.ALVO_UNICO)));

        mago.aprenderMagia(new Magia(
                "Labaredas Vivas", "Atingindo inimigos com chamas contínuas",
                22, TipoDeEfeito.DANO_POR_TURNO, 24, 3, TipoAlvo.TODOS_INIMIGOS,
                NomeEfeito.FOGO, List.of(TagMagia.FOGO, TagMagia.DANO, TagMagia.AREA)));
        return mago;
    }
    ...
    public Mago criarCriomante(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                17, TipoDeEfeito.DANO_DIRETO, 26, 1, TipoAlvo.ALVO_UNICO,
                NomeEfeito.NENHUM, List.of(TagMagia.GELO, TagMagia.DANO, TagMagia.ALVO_UNICO)));

        mago.aprenderMagia(new Magia(
                "Torrão Congelado", "Congelando o inimigo em um bloco de gelo",
                22, TipoDeEfeito.CONTROLE, 0, 1, TipoAlvo.ALVO_UNICO,
                NomeEfeito.CONGELADO, List.of(TagMagia.GELO, TagMagia.CONTROLE)));
        return mago;
    }
    ...
    public Mago criarUmbramante(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                18, TipoDeEfeito.DANO_POR_TURNO, 24, 3, TipoAlvo.ALVO_UNICO,
                NomeEfeito.SANGRAMENTO, List.of(TagMagia.SOMBRA, TagMagia.DANO, TagMagia.ALVO_UNICO)));

        mago.aprenderMagia(new Magia(
                "Escuridão Total", "Cegando os inimigos em escuridão",
                20, TipoDeEfeito.DEBUFF_PRECISAO, 20, 2, TipoAlvo.TODOS_INIMIGOS,
                NomeEfeito.CEGUEIRA, List.of(TagMagia.SOMBRA, TagMagia.DEBUFF, TagMagia.AREA)));
        return mago;
    }
    ...
    public Mago criarDruida(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                18, TipoDeEfeito.CURA, 28, 1, TipoAlvo.ALIADO,
                NomeEfeito.NENHUM, List.of(TagMagia.NATUREZA, TagMagia.CURA, TagMagia.ALVO_UNICO)));

        mago.aprenderMagia(new Magia(
                "Raízes Aprisionadoras", "Reduzindo a agilidade dos inimigos",
                22, TipoDeEfeito.DEBUFF_AGILIDADE, 18, 2, TipoAlvo.TODOS_INIMIGOS,
                NomeEfeito.AMENDONTRAR, List.of(TagMagia.NATUREZA, TagMagia.DEBUFF, TagMagia.AREA)));
        return mago;
    }
    ...
    public Mago criarGuardiaoRunico(String nome) {
        ...
        mago.aprenderMagia(new Magia(
                ...
                18, TipoDeEfeito.BUFF_DEFESA, 12, 3, TipoAlvo.ALIADO,
                NomeEfeito.RESISTENTE, List.of(TagMagia.NATUREZA, TagMagia.BUFF)));
        return mago;
    }
