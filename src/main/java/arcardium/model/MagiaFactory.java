...
public class MagiaFactory {
    ...
    private static final List<Magia> TODAS_AS_MAGIAS = List.of(
            ...
            new Magia("Congelamento Instantâneo", "Congelando instantaneamente o inimigo, reduzindo sua velocidade", 18, TipoDeEfeito.DEBUFF_AGILIDADE, 0, 2, TipoAlvo.ALVO_UNICO, NomeEfeito.CONGELADO, List.of(TagMagia.GELO, TagMagia.DEBUFF)),
            ...
            new Magia("Torrão Congelado", "Transformando o inimigo em um bloco de gelo, diminuindo sua mobilidade", 20, TipoDeEfeito.DEBUFF_AGILIDADE, 0, 2, TipoAlvo.ALVO_UNICO, NomeEfeito.CONGELADO, List.of(TagMagia.GELO, TagMagia.DEBUFF)),
            ...
            new Magia("Escuridão Total", "Cobertura de escuridão cegando todos os inimigos ao redor", 18, TipoDeEfeito.DEBUFF_PRECISAO, 0, 2, TipoAlvo.TODOS_INIMIGOS, NomeEfeito.CEGUEIRA, List.of(TagMagia.SOMBRA, TagMagia.DEBUFF)),
            new Magia("Corte Sombrio", "Desferindo um corte sombrio que enfraquece a defesa do alvo", 22, TipoDeEfeito.DEBUFF_DEFESA, 10, 2, TipoAlvo.ALVO_UNICO, NomeEfeito.FRACO, List.of(TagMagia.SOMBRA, TagMagia.DEBUFF)),
            ...
            new Magia("Manto Sombrio", "Envolvendo-se em sombras que aumentam a evasão do alvo", 20, TipoDeEfeito.BUFF_EVASAO, 20, 2, TipoAlvo.ALIADO, NomeEfeito.AGIL, List.of(TagMagia.SOMBRA, TagMagia.BUFF)),
            ...
            new Magia("Visão Sombria", "Mostrando ao aliado uma visão de sombras, aumentando sua agilidade", 18, TipoDeEfeito.BUFF_AGILIDADE, 10, 2, TipoAlvo.ALIADO, NomeEfeito.AGIL, List.of(TagMagia.SOMBRA, TagMagia.BUFF)),
            ...
            new Magia("Rugido da Terra", "Liberando uma onda de força natural que atordoa os inimigos próximos", 15, TipoDeEfeito.DEBUFF_DEFESA, 10, 1, TipoAlvo.TODOS_INIMIGOS, NomeEfeito.MALDICAO, List.of(TagMagia.NATUREZA, TagMagia.DEBUFF, TagMagia.AREA)),
            new Magia("Raízes Aprisionadoras", "Crescendo raízes que imobilizam inimigos, reduzindo sua agilidade", 22, TipoDeEfeito.DEBUFF_AGILIDADE, 15, 2, TipoAlvo.TODOS_INIMIGOS, NomeEfeito.AMENDONTRAR, List.of(TagMagia.NATUREZA, TagMagia.DEBUFF, TagMagia.AREA)),
