...
public class Inimigo extends Heroi {
    ...
    public Inimigo(String nome, int hp, int mp, int atk, int def, int agi, int pre, int eva, RankInimigo rank, Comportamento comportamento, int chanceDeCrit, int danoCrit) {
